 ...
 * @see <a href="https://secure.wikimedia.org/wikipedia/en/wiki/Graph_Modelling_Language">
 *     Graph Modelling Language on Wikipedia</a>
 *
 * <h2>Example</h2>
 * <pre>
 * graph [
...
public class GMLParser {
    ...
    private NetworkGraph.AttributeStore parseAttributes() {
        return new NetworkGraph.AttributeStore();
    }
