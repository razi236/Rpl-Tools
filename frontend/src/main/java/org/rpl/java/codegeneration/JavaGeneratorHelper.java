...
import org.rpl.backend.java.scheduling.UserSchedulingStrategy;
...
import org.rpl.frontend.ast.AsyncCall;
...
import org.rpl.frontend.ast.ExpGuard;
import org.rpl.frontend.ast.FnApp;
import org.rpl.frontend.ast.FunctionDecl;
import org.rpl.frontend.ast.HasTypeParameters;
import org.rpl.frontend.ast.LetExp;
...
import org.rpl.frontend.ast.ThisExp;
import org.rpl.frontend.ast.TypeParameterDecl;
import org.rpl.frontend.ast.TypedVarOrFieldDecl;
import org.rpl.frontend.ast.VarDecl;
import org.rpl.frontend.ast.VarOrFieldDecl;
import org.rpl.frontend.ast.VarUse;
...
//        stream.println(");");
    ...
    private static void generateTaskInitMethod(PrintStream stream, final java.util.List<Type> paramTypes) {
        int i;
        stream.print("public " + org.rpl.backend.java.lib.runtime.AsyncCall.class.getName() + "<?> init(");
        i = 0;
        for (Type t : paramTypes) {
            if (i > 0) stream.print(",");
