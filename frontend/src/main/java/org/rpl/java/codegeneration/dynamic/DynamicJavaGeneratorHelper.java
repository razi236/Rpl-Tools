 ...
 */
package org.rpl.backend.java.codegeneration.dynamic;
...
import org.rpl.backend.java.JavaBackend;
import org.rpl.backend.java.codegeneration.JavaCodeGenerationException;
import org.rpl.backend.java.codegeneration.JavaCodeStream;
import org.rpl.backend.java.codegeneration.JavaGeneratorHelper;
import org.rpl.backend.java.JavaBackendConstants;
import org.rpl.backend.java.codegeneration.JavaCode;
import org.rpl.backend.java.lib.runtime.ABSBuiltInFunctions;
import org.rpl.backend.java.lib.runtime.*;
import org.rpl.backend.java.lib.runtime.ABSDynamicRuntime;
...
public class DynamicJavaGeneratorHelper {
    ...
    public static void generateAsyncCall(PrintStream stream, org.rpl.frontend.ast.AsyncCall call) {
    ...
    private static void generateTaskInitMethod(PrintStream stream, final java.util.List<Type> paramTypes) {
        stream.print("public " + AsyncCall.class.getName() + "<?> init(");
        for (int i = 0; i < paramTypes.size(); i++) {
            if (i > 0) stream.print(", ");
