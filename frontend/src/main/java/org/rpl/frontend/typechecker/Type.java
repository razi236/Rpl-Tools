...
public abstract class Type {
    ...
    public Type withAnnotations(org.rpl.frontend.ast.List<Annotation> anns) {
    ...
    private List<TypeAnnotation> convertToTypeAnnotations(org.rpl.frontend.ast.List<Annotation> anns) {
    ...
    public boolean isNumericType() {
        return isIntType() || isRatType() || isFloatType();
    }
