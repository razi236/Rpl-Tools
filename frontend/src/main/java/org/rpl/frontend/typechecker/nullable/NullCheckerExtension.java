...
import org.rpl.frontend.typechecker.TypeAnnotation;
import org.rpl.frontend.typechecker.ext.DefaultTypeSystemExtension;
...
public class NullCheckerExtension extends DefaultTypeSystemExtension {
    ...
    public static org.rpl.frontend.ast.List<Annotation> getAnnotations(Type t) {
        org.rpl.frontend.ast.List<Annotation> as = new org.rpl.frontend.ast.List<>();
