 ...
 *
 */
public class RPLPackageFile extends JarFile {

    public static final String VERSION_ATTRIBUTE = "ABS-Package-Version";

    /**
     * Creates a new RPLPackageFile from the given File object
     * @param file the ABS package file to be read
     * @throws IOException if the file could not be read
     */
    public RPLPackageFile(File file) throws IOException {
        super(file);
    }
     ...
     */
    public boolean isRPLPackage() throws IOException {
